...
export class QTable {
  ...
  private map: Map<number, number>; // Dictionary mapping (s, a) -> Q(s, a).
  private initialQ: number; // Initial Q-values.
  private numActions: number; // Number of actions in environment.
