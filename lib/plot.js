class Plot{
	constructor(data,id,axes_labels,value) {
		this.data = data
		this.x_label = axes_labels.x
		this.y_label = axes_labels.y
		this.value = value
...
class TooltipPlot extends Plot {
	constructor(data,id,axes_labels,value) {
		super(data,id,axes_labels,value)
...
class RewardPlot extends TooltipPlot {
	constructor(trace) {
		...
		super(data,"reward_plot",{x:"Cycles",y:"Average reward"},"rew")
	}
}

class IGPlot extends TooltipPlot {
	constructor(trace) {
		super(trace,"ig_plot",{x:"Cycles",y:"Information gain"},"IG")
	}
}
