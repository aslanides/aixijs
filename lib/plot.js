class Plot{
	constructor(data,id,axis_label,value){
		this.data = data
...
class RewardPlot extends Plot {
	constructor(trace) {
        var i = 0
        var data = trace.map(function(x) {i++;return x/i})
		super(data,"reward_plot","Average reward","rew")
	}
}

class IGPlot extends Plot {
	constructor(trace) {
		super(trace,"ig_plot","Information gain","IG")
	}
}
