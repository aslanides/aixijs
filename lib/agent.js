class Agent {
	constructor(options) {
		...
		this.tracer = Trace;
	//	this.discount_array = [{time : ...}, {discount = new Discount..(params)}] //Need an array of which discount functions to use and when
	//	this.current_discount = this.discount_array[0].discount
		// (can either put entry per time cycle or have entries as times when to change and to what function )
	}
