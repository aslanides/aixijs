...
class RandomDemo extends Demo {
	...
	static setOptions(doc) {
		Options.setParams(doc,{cycles:1e5})
	}
}
...
class BayesDemo extends Demo {
	static setOptions(doc) {
		Options.setParams(doc,{horizon:6,samples:400,ucb:1,cycles:1e2})
	}
}
	...
	class AIMUDemo extends BayesDemo {
		...
		class AIMUDispenserDemo1 extends AIMUDemo {
		    constructor(options) {
		...
		class AIMUDispenserDemo2 extends AIMUDemo {
		    constructor(options) {
				super(options,SimpleDispenserGrid,environments.dispenser3)
		    }
			static setOptions(doc) {
				super.setOptions(doc)
				Options.setParams(doc,{horizon:6,samples:1000,cycles:60})
			}
		}

		class AIMUEpisodicDemo extends AIMUDemo {
			constructor(options) {
				super(options,EpisodicGrid,environments.episodic1)
		    }
			static setOptions(doc) {
				super.setOptions(doc)
	...
	class AIXIDemo extends BayesDemo {
		...
		class AIXIEpisodicDemo2 extends AIXIDemo {
			constructor(options) {
				super(options,EpisodicGrid,environments.episodic2)
		    }
			static setOptions(doc) {
				super.setOptions(doc)
...
class ThompsonDemo extends Demo {
	...
	static setOptions(doc) {
		...
		Options.setParams(doc,{horizon:3,samples:500,ucb:1,cycles:500})
	}
}

	class ThompsonDemo1 extends ThompsonDemo {
	    constructor(options) {
	        super(options,environments.dispenser3)
	    }
	}
