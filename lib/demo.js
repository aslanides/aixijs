...
const demos = {
	...
	KLKSA_dirichlet_dispenser: {
		name: 'KL-KSA-Dirichlet vs DispenserGrid2',
		agent: KullbackLeiblerKSA,
		env: SimpleDispenserGrid,
		model: DirichletModel,
		tracer: DirichletTrace,
	...
	ShannonKSA_dirichlet_dispenser: {
		name: 'Shannon KSA-Dirichlet vs DispenserGrid2',
		agent: ShannonKSA,
		env: SimpleDispenserGrid,
		model: DirichletModel,
		tracer: DirichletTrace,
	...
	aixi_ipd: {
		...
		trace: Trace,
		vis: null,
		config: environments.prisoners_dilemma,
		params: {
			horizon: 5,
			samples: 600,
			ucb: 1,
	...
	ql_bandit: {
		...
		env: Bandit,
		vis: BanditVis,
		config: environments.gaussbandit,
		params: {
			alpha: 0.9,
			gamma: 0.99,
			epsilon: 0.05,
