...
class QLearnDemo extends Demo {
	...
	class QLearnMDPDemo extends QLearnDemo{
		constructor(options){
			super(options, BasicMDP, MDPVis, MDPs.MDP1)
		}
		static setOptions(doc) {
			super.setOptions(doc)
			Options.setParams(doc,{alpha:0.9,gamma:0.99,epsilon:0.01,cycles:1e3})
...
/* Don't really need this as demo is based on agent
class MDPDemo extends Demo {
	constructor(options,cfg) {
		var cl = BasicMDP
		var env = new cl(cfg)
		//TODO .....
	...
	class MDPDemo1 extends MDPDemo {
		constructor(options) {
			super(options, MDPs.MDP1)
		}
	}
*/
