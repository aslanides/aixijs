...
class IteratedPrisonersDilemma extends Environment {
	...
	perform(a) {
		let e = this.payouts[b][a];
		let b = this.opponent.selectAction(e);
		this.a = a;
		this.b = b;

		this.opponent.update(a, e);
	}

	generatePercept() {
		// 0 = defect, 1 = cooperate
		return this.payouts[this.a][this.b];
	}

	conditionalDistribution(e) {
		return this.opponent.pr(this.b);
	}
