...
//Implement time inconsistent env based on MDP implementation for now
class TimeInconsistentEnv1 extends Environment {
	constructor(config) {
		super(config);
		this.states = [0, 1, 2];
		...
		this.instant_reward = 1;
		let numActions = 3; //instant and delayed actions
		this.actions = new Array(numActions);
...
//conditionalDistribution method, returns 1 ..
