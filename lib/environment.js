    ...
    constructor(config) {
        ...
        for (var i = 0; i < this.M; i++) {
            ...
            for (var j = 0; j < this.N; j++) {
                var type = map ? map[i][j] : map_symbols.empty
                this.tiles[i][j] = Tile.new(i,j,config,type)
            }
        }
    }
    getTile(i,j) {
...
class SignPostedTigerGrid extends Gridworld {
